  ...
  return (
    <aside className="campus-rail marketplace-studio-rail">
      <section className="marketplace-studio-rail-card marketplace-studio-summary">
        ...
        <span>{studio.foodMode ? `${studio.form.category} · Campus pickup` : `${studio.form.category} · ${studio.form.kind === 'service' ? studio.form.serviceMode.replaceAll('_', ' ') : studio.form.condition}`}</span>
        ...
        <small><FiPackage aria-hidden="true" />{studio.form.stock || 0} {studio.foodMode ? 'servings today' : studio.form.kind === 'service' ? 'slots' : 'in stock'}</small>
      </section>
