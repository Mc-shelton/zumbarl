...
export function useBusinessOpportunityCreate({
  ...
  const activeStepMeta =
    BUSINESS_CREATE_STEPS[activeStep - 1] || BUSINESS_CREATE_STEPS[0];
  const deliverableCount = Object.values(form.deliverables).reduce(
