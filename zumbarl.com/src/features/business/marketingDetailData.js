export const BUSINESS_MARKETING_DETAIL_TABS = [
  ...
  { id: 'creators', label: 'Creator Collaborations' },
...
export const BUSINESS_MARKETING_CAMPAIGN_DETAILS = {
  'level-up-skills': {
    ...
    pickupAccess: 'Eligible creators can pick it up immediately',
    ...
    timeline: [
      ...
      { label: 'Open for pickup', date: 'May 13 - May 20, 2025', status: 'done' },
    ...
    activity: [
      ...
      'A qualified creator picked up a campaign slot.',
    ],
  },
}
