...
export const BUSINESS_APPLICANT_PROFILE_SEO = {
  title: 'Zumbarl Business | Applicant Profile',
  description:
    'Review applicant performance, portfolio highlights, pipeline stage, endorsements, and business engagement history.',
  path: '/business/applicant-profile',
  keywords:
    'Zumbarl business applicant profile, talent profile, applicant pipeline, student portfolio, business talent review',
  pageJsonLd: buildWebPageJsonLd({
    title: 'Zumbarl Business | Applicant Profile',
    description:
      'Review applicant performance, portfolio highlights, pipeline stage, endorsements, and business engagement history.',
