...
import { listRegistrationCampusesService, listRegistrationCoursesService, loginUserService, readAuthenticatedUserService, registerUserService, searchRegistrationLocationsService } from '../../../../adapters/services/auth/index.js'
